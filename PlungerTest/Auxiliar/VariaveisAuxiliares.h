...
#ifndef VariaveisAuxiliaresH
#define VariaveisAuxiliaresH
#include <fstream>
using namespace std;
//---------------------------------------------------------------------------

class VariaveisAuxiliares
{
public:
	...
	static VariaveisAuxiliares* getInstance();
	void Limpar();
	/** Imprime as variáveis da classe */
    void imprimirVariaveis(ofstream& file);
private:
  //! Única instância da classe
  static VariaveisAuxiliares* instance;
